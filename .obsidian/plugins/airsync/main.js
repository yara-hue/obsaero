...
var AirsyncSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("API Key").setDesc("Firebase Web API Key").addText(
      (text) => text.setPlaceholder("AIzaSy...").setValue(this.plugin.settings.firebaseApiKey).onChange(async (val) => {
    ...
    new import_obsidian.Setting(containerEl).setName("Auth Domain").setDesc("Firebase Auth Domain").addText(
      (text) => text.setPlaceholder("your-project.firebaseapp.com").setValue(this.plugin.settings.firebaseAuthDomain).onChange(async (val) => {
    ...
    new import_obsidian.Setting(containerEl).setName("Database URL").setDesc("Firebase Realtime Database URL").addText(
      (text) => text.setPlaceholder("https://your-project-default-rtdb.firebaseio.com").setValue(this.plugin.settings.firebaseDatabaseURL).onChange(async (val) => {
    ...
    new import_obsidian.Setting(containerEl).setName("Project ID").setDesc("Firebase Project ID").addText(
      (text) => text.setPlaceholder("your-project").setValue(this.plugin.settings.firebaseProjectId).onChange(async (val) => {
    ...
    new import_obsidian.Setting(containerEl).setName("Display Name").setDesc("Your name shown to collaborators").addText(
      (text) => text.setPlaceholder("Enter your display name").setValue(this.plugin.settings.displayName).onChange(async (val) => {
