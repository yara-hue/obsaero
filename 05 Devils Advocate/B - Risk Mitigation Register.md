...
| 2 | _e.g. "Too expensive for airlines to implement"_ | _e.g. Teammate 2_ | _Medium_ | _e.g. Cost offset by waste disposal savings within 18 months_ | _Open_ |
| 3 | _e.g. "Crew won't follow the new protocol"_ | _e.g. Teammate 3_ | _High_ | _e.g. Simplified 2-step flow requires no extra training_ | _Open_ |
