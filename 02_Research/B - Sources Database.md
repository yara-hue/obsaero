...
*   **How to use:** Every time you find a real-world statistic or PDF, log it here using a clean markdown table row. This serves as the master bibliography for our pitch.
