...
var AirsyncSettingTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("Reconnect").setDesc("Attempt to reconnect to Firebase with current settings").addButton(
    ...
    try {
      ...
      this.authUnsub = this.firebase.onAuthChanged(async (user) => {
        if (user) {
          ...
          const isFirstTime = await this.firebase.checkFirstTimeUser(user.uid);
          if (isFirstTime) {
            new DisplayNameModal(this.app, this).open();
      ...
      new import_obsidian2.Notice("Airsync: Failed to connect to Firebase. Check settings.");
    }
  }
  onunload() {
    this.authUnsub();
